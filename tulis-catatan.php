          ...
          <div class="col-12">
            <div class="container text-left">
              <form method="post" action="">
                ...
                <div class="form-group">
                  <label for="Jelaskan"><b class="h4">Deskripsi Pertanyaan</b></label>
                  <textarea name="deskripsi" class="form-control" rows="7" placeholder="Jelaskan Pertanyaan"></textarea>
                </div>
                <span class="badge badge-dark mb-3">ATAU</span>
                 <div class="custom-file mb-3">
                  <input name="gambar" type="file" class="custom-file-input" id="validatedCustomFile">
                  <label class="custom-file-label" for="validatedCustomFile">Choose file...</label>
                  <div class="invalid-feedback">Example invalid custom file feedback</div>
                </div>
                <div class="form-group">
                  <label for="tag"><b class="h4">Tags</b></label>
                  <input name="tags" type="text" class="form-control" rows="10" placeholder="Tags: #SBMPTN #UTBK"></input>
                </div>
                <input type="submit" class="btn btn-primary" value="Posting Catatan" name="submit">
              </form>
            </div>
          </div>
        </div>
