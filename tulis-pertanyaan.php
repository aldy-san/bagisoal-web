            ...
            <div class="container text-left">
              <form method="post" action="">
                ...
                <div class="form-group">
                  ...
                  <textarea name="isi_pertanyaan" class="form-control" rows="7" placeholder="Jelaskan Pertanyaan"></textarea>
                </div>
                <div class="form-group">
                  <label for="tag"><b class="h4">Tags</b></label>
                  <input name="tags_pertanyaan" type="text" class="form-control" rows="10" placeholder="Tags: #SBMPTN #UTBK"></input>
                </div>
                <input type="submit" class="btn btn-primary" value="Posting Pertanyaan" name="submit">
              </form>
            </div>
          </div>
        </div>
